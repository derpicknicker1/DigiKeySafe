/*******************************************************
 ...
 Latest version generated:	15.10.2009
 Filename:					Main.c
 Description:    			Main routine for testing
 							TWI-Slave-main.c

 Updated: 15.10.2009
 Die Laufvariable j wurde in den folgenden Anweisungen
 TWIS_Write und printf (..) ersetzt durch die Variable i.
 ...
 Dank an Johannes Kreuzer, der den Fehler bemerkt hatte !!
 ********************************************************/
#include <stdio.h>
